...
dest_dir=/media/AiDisk_a2/data && dest_port=17500
# ------- scp to youku-L1_TF ----------
[ "${router:=jhk2p}" = youku ] && dest_dir=/media/AiCard_02/data && dest_port=11100
# ------- scp to szk2p_usb ----------
[ "$router" = szk2p ] && dest_dir=/media/AiDisk_a1/data && dest_port=17920
