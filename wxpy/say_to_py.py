...
def send_message(your_message):
    try:
        ...
        # 出问题时，发送信息到文件传输助手
        bot.file_helper.send(u"守护对方出问题了，赶紧去看看咋回事~")
...
def print_others(msg):
    ...
    # 发送信息到文件传输助手
    mood_message = u"来自对方的消息:" + msg.text + "\n当前情感得分:" + now_mod_rank + "\n越接近1表示心情越好，越接近0表示心情越差，情感结果仅供参考，请勿完全相信！\n\n"
