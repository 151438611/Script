...
if (empty($inputKeywords1.$inputKeywords2.$inputKeywords3)) { 
    die(""); 
} 
...
$select = "SELECT * FROM $db_name.$tab_name WHERE OS like '%$inputKeywords1%' AND Type like '%$inputKeywords2%' AND Ask like '%$inputKeywords3%'";
