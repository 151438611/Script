...
echo "   测试电脑2(下)需配置IP信息: eth1:192.168.6.201 eth2:192.168.7.201 eth3:192.168.8.201 eth4:192.168.9.201"
echo -e "\n2、二台电脑的同号端口相连,不可混连,否则无法测试; 例如: eth1连接eth1、eth2连接eth2 依此连接"
